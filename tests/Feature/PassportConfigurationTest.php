...
class PassportConfigurationTest extends TestCase
{
    ...
    public function test_token_lifetimes_are_set(): void
    {
        ...
        $tokenSeconds = \Carbon\CarbonInterval::instance(Passport::tokensExpireIn())->totalSeconds;
        $refreshSeconds = \Carbon\CarbonInterval::instance(Passport::refreshTokensExpireIn())->totalSeconds;
